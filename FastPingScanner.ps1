...
function Global:Ping-IPRange {
    ...
    $IPrange | foreach{
        ...
        [string]$UName = "GetUser_" + $_.Address

        New-Variable -Name $VarName -Value (New-Object System.Net.NetworkInformation.Ping)
        New-Variable -Name $UName -Value (New-Object System.Management.ManagementBaseObject)
...
Ping-IPRange -StartAddress 192.168.1.1 -EndAddress 192.168.1.255 -Interval 20   
Ping-IPRange -StartAddress 192.168.10.1 -EndAddress 192.168.10.255 -Interval 20 
